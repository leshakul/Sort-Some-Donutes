...
public class MoveFood : MonoBehaviour
{
    ...
    [SerializeField] private Food _firstClickFood;
    [SerializeField] private Food _secondClickFood;
    ...
    private void GetLane(Lane lane)
    {
        ...
        if (_secondLane == null && lane != _firstLane && !_isMoving)
        {
            _secondLane = lane;                     
        }     
    ...
    {
       if (_firstClickFood == null && !_isMoving)
       {
            _firstClickFood = food;
       }

       if (_secondClickFood == null && food != _firstClickFood && _firstClickFood.FoodId != food.FoodId && !_isMoving)
       {
